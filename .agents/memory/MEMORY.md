...
- [Copilot streaming and action integrity](copilot-streaming-action-integrity.md) — stream verified progress, never hidden reasoning; confirmed writes use one-time server-side grants.
